...
readonly PROJECT="m3780"

# Simulation
readonly COMPSET="GMPAS-JRA"
readonly RESOLUTION="TL319_IcoswISC30E3r5"
# BEFORE RUNNING : CHANGE the following CASE_NAME to desired value
readonly CASE_NAME="IcoswISC30E3r5_GMPAS-JRA_Bod2023_NO_mld_decaying_tfilt_Cr_${config_submesoscale_cr}"
...
# Set paths
readonly CASE_ROOT="/global/cfs/cdirs/m3780/dylan617/${CASE_NAME}"
readonly CODE_ROOT="/pscratch/sd/d/dylan617/E3SM/add-bodner-mle"
...
# Add custom processor layout for ICOS30
pre_build_xml
...
config_submesoscale_cr = ${config_submesoscale_cr}
EOF
...
#-----------------------------------------------------
pre_build_xml() {
    echo $'\n----- Pre-build XML configuration -----\n'
    pushd ${CASE_SCRIPTS_DIR}

    # Put ALL PE / layout / task-related changes here
    ./xmlchange NTASKS_ATM=1280
    ./xmlchange NTASKS_CPL=1280
    ./xmlchange NTASKS_OCN=1280
    ./xmlchange NTASKS_WAV=1280
    ./xmlchange NTASKS_GLC=1280
    ./xmlchange NTASKS_ICE=1280
    ./xmlchange NTASKS_ROF=1280
    ./xmlchange NTASKS_LND=1280
    ./xmlchange NTASKS_ESP=1280
    ./xmlchange NTASKS_IAC=1280

    # also anything that affects decomposition or layout logic
    # ./xmlchange MAX_TASKS_PER_NODE=...
    # ./xmlchange MAX_MPITASKS_PER_NODE=...
